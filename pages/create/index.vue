    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            <div class="flex items-center mb-6">
                ...
                <h1 class="text-3xl font-bold">Create New</h1>
            </div>

            <form @submit.prevent="performCreate" class="bg-white shadow-md rounded px-8 pt-6 pb-8">
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-gray-600 text-xs mt-1">Optional: An icon or emoji to represent this platform</p>
                </div>
